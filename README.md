...
- При расширенной конфигурации в шаблонах необходимо самостоятельно прописать подключение сжатых JS и CSS файлов. По умолчанию это /assets/templates/script.js и /assets/templates/style.css
